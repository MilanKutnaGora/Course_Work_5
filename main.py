...
if __name__ == "__main__":
    print("Привет! Я программа, которая собирает вакансии с лучших компаний HeadHunter!\n"
          """Сейчас в моей базе 10 компаний, а именно: 
        "ПАО НК Роснефть-Алтайнефтепродукт",
        "НК Роснефть - АО Воронежнефтепродукт",
        "НК Роснефть - Восточно-Сибирская нефтегазовая компания",
        "АО НК Роснефть - Кубаньнефтепродукт",
        "АО НК Роснефть-МЗ Нефтепродукт",
        "АО НК Роснефть-Мурманскнефтепродукт",
        "ПАО НК Роснефть - Смоленскнефтепродукт",
        "АО «НК «Роснефть» - Ставрополье»",
        "Роснефть - НТЦ",
        "ООО Роснефть РН-Северо-Запад"\n"
